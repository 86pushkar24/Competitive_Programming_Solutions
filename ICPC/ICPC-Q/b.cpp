...
//         if (nodes < 0 || (leaves > 0 && ceilDiv(nodes, leaves) > d / 2 + 1))
//         {
//             cout << "-1" << endl;
//             continue;
//         }
...
//         {
//             int groupSize = min(leaves, remainingNodes);
//             for (int i = 0; i < groupSize; i++)
//             {
//                 edges.pb({parent, ++current});
//             }
//             parent++;
