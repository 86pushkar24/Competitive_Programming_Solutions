...
void push() {
    ...
    for (int i = floor(sqrt(n)); i >= 1; i--) {
        if (n % i == 0) {
            int l1 = 0, l2 = 0, b1, b2;
            string p1 = s.substr(0, i), p2 = s.substr(n - i, i);

            for0(j, n / i) {
                if (p1 != s.substr(j * i, i)) {
                    l1++;
                    b1 = j * i;
                }
                if (p2 != s.substr(j * i, i)) {
                    l2++;
                    b2 = j * i;
                }
            }
        ...
        if (n % i == 0) {
            int t = n / i;
            int l1 = 0, l2 = 0, b1, b2;
            string p1 = s.substr(0, t), p2 = s.substr(n - t, t);

            for0(j, n / t) {
                if (p1 != s.substr(j * t, t)) {
                    l1++;
                    b1 = j * t;
                }
                if (p2 != s.substr(j * t, t)) {
                    l2++;
                    b2 = j * t;
                }
            }
